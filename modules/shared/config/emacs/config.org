...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/andrestreto/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/andrestreto/bin" "/profile/bin" "/Users/andrestreto/.npm-packages/bin" "/Users/andrestreto/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
